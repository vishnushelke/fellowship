...
import com.bridgelabz.structural.adapter.services.SocketClassAdapterImpl;
import com.bridgelabz.structural.adapter.services.SocketObjectAdapterImpl;
...
public class AdapterPatternTest {
	...
	private static void testObjectAdapter() {
		SocketAdapter sockAdapter = (SocketAdapter) new SocketObjectAdapterImpl();
	...
	private static void testClassAdapter() {
		SocketAdapter sockAdapter = (SocketAdapter) new SocketClassAdapterImpl();
		Volt v3 = getVolt(sockAdapter,3);
		Volt v12 = getVolt(sockAdapter,12);
		Volt v120 = getVolt(sockAdapter,120);
